...
const Products = () => {
  ...
  useEffect(() => {
    // Verificar en el localStorage si el usuario ha iniciado sesión y tiene el rol de admin
    const userLoggedIn = localStorage.getItem('loggedIn');
    const userRol = localStorage.getItem('userRol');

    if (userLoggedIn !== 'true' || userRol !== 'admin') {
      // Si el usuario no cumple con los requisitos, redirigirlo a la página de inicio de sesión
      history.push('/');
    }
  }, [history]);
